...
Hci.prototype.setScanParameters = function(scanInterval) {
  ...
  cmd.writeUInt16LE(scanInterval || 0x0010, 5); // internal, ms * 1.6
  cmd.writeUInt16LE(scanInterval || 0x0010, 7); // window, ms * 1.6
